...
@Component({
  selector: 'app-mobilequiz',
  templateUrl: './mobilequizzes-list.component.html',
  styleUrls : ['./mobilequizzes-list.component.css']
})
export class MobileQuizzesListComponent implements OnInit{
